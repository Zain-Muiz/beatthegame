...
const setMyteam = () => {
    ...
    playersList = myTeam.reduce((playerhtml, player) => {
        ...
        playerhtml += `<div class = "col-12 text-center shadow-lg  mb-1 bg-white rounded-pill mx-auto" style = " border:1px solid white;overflow:hidden;" >
...
const setPlayers = () => {
    ...
    playersList = players.reduce((playerhtml, player) => {
        ...
        if(player.skill === activeTab){
            ...
            playerhtml += `<div class = "col-12 text-center shadow-lg  mb-1 bg-white rounded-pill  mx-auto" style = " border:1px solid white; background-color:black; overflow:hidden;" >
...
const updateCredit = () => {
    ...
    rCreditHtml = `<div class = "text-center"> <h6 style = "color:red;font-weight:550;" class = "">Credits: ${remainingCredit} <i class="fa fa-arrow-down" aria-hidden="true"></i></h6></div>`;
    uCreditHtml = `<div class = "text-center "><h6 style = "color:#07f20b; font-weight:550;" >Credits: ${usedCredit} <i class="fa fa-arrow-up" aria-hidden="true"></i></h6></div>`;
...
function glowEnter2(parent){
    ...
    parent.style.border= ".25vmin solid #1296e3";
